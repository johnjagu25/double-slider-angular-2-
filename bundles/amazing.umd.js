(function (global, factory) {
    ...
    (factory((global.ng = global.ng || {}, global.ng.amazing = {}),global.ng.core,null));
    ...
    var DoubleSliderComponent = /** @class */ (function () {
        function DoubleSliderComponent(cdr) {
            ...
            this.increment = 0;
            this.disable = false;
            this.minChange = new core.EventEmitter();
            this.maxChange = new core.EventEmitter();
        ...
        DoubleSliderComponent.propDecorators = {
            ...
            "tooltipSymbol": [{ type: core.Input, args: ["tooltipSymbol",] },],
            "minValue": [{ type: core.Input, args: ["min",] },],
            "maxValue": [{ type: core.Input, args: ["max",] },],
            "increment": [{ type: core.Input, args: ["increment",] },],
            "disable": [{ type: core.Input, args: ["disable",] },],
            "minChange": [{ type: core.Output, args: ["minChange",] },],
            "maxChange": [{ type: core.Output, args: ["maxChange",] },],
            "dbSlider": [{ type: core.ViewChild, args: ["dbSlider1",] },],
            "slideMin": [{ type: core.ViewChild, args: ["slideMin",] },],
            "slideMax": [{ type: core.ViewChild, args: ["slideMax",] },],
            "progress": [{ type: core.ViewChild, args: ["sliderProgress",] },],
            "sliderMiddle": [{ type: core.Input, args: ["sliderMiddle",] },],
            "sliderMinIcon": [{ type: core.Input, args: ["sliderMinIcon",] },],
            "onMove": [{ type: core.HostListener, args: ['document:mousemove', ['$event'],] }, { type: core.HostListener, args: ['document:touchmove', ['$event'],] },],
            "mouseup": [{ type: core.HostListener, args: ['document:mouseup', ['$event'],] }, { type: core.HostListener, args: ['document:touchend', ['$event'],] },],
        };
